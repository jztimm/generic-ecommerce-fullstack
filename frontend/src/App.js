    ...
    <Router>
      ...
      <main className="py-3">
        <Container>
          ...
          <Route path="/payment" component={PaymentScreen}/>  {/* Redirects you to the login page*/}
          <Route path="/placeorder" component={PlaceOrderScreen}/>  {/* Redirects you to the login page*/}
